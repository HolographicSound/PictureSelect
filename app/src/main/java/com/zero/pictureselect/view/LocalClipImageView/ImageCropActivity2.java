package com.zero.pictureselect.view.LocalClipImageView;
...
public class ImageCropActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    public static void start(Activity a, String imagePath) {
        ...
        a.startActivityForResult(i, Constant.RequestCode.ImageCrop);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clip_commit:
                ...
                String path = mClipImageLayout.clip(Constant.IMAGE_TMMP_PATH);
                Intent i = new Intent();
                i.putExtra(Constant.ResultDataKey.PICTURE_CLIP_DATA, path);
